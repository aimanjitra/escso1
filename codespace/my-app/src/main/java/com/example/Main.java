    ...
    <style>
        ...
        * {
        ...
        body {
            ...
            background: 
                linear-gradient(rgba(15, 15, 15, 0.9), rgba(25, 25, 25, 0.95)),
...
.loading-message {
    ...
    font-family: inherit;   /* ✅ FIX monospace inheritance */
    white-space: normal;    /* ✅ FIX pre-wrap inheritance */
}
...
/* ✅ Force all gateway / error messages to be visually centered */
.gateway-message {
...
<div id="optionB" style="display:none;">
    <div class="input-row">
        ...
        <!-- XML Import / Export -->
        <div class="input-row">
            <button class="add-btn" onclick="exportToXML()">Export XML</button>
            <input 
    type="file"
    id="xmlFileInput"
...
>
        ...
        <div class="test-cases-section" id="testCasesSection">
            ...
            <div class="test-cases-count" id="testCasesCount">0 test cases generated</div>
                        <div class="btn-container" style="margin-bottom:15px;">
                            <button class="generate-btn" onclick="savePNGB()">Save as PNG</button>
                            <button class="generate-btn" onclick="downloadTextB()">Save as TXT</button>
                        </div>
    ...
    <div class="footer">
        ...
        <div class="copyright">
            <strong>© 2026 Universiti Malaysia Perlis (UniMAP) — Faculty of Intelligent Computing</strong>
        </div>

        <div class="developers">
            Developed by:<br>
            Muhammad Aiman bin Mohd Asyraf, 
            Assoc. Prof. Dr. Rozmie Razif B. Othman,
            Ts. Dr. Mohd Zamri B. Zahir Ahmad, Ts. Dr. Ahmad Ashraf Abdul Halim,
    ...
    <script>
        ...
        function updateFormula() {
            ...
            // Build symbolic representation: 3×2²
            const freq = {};
    ...
    // 🔓 Re-enable button so retry works
    generateBtn.disabled = false;
    generateBtn.textContent = "Generate Test Suite";

    // ⏳ 1 minute 40 seconds retry
    setTimeout(() => {
        retryFn();
    }, 100000);
}
    ...
    try {
                                            ...
                                            <div class="inputs-list">
                                                ...
                                                ${param.inputs.map((input, inputIndex) => `
                                                    <div class="input-item">
                                                        ...
                                                        <button class="delete-input-btn" onclick="removeInputFromParameter(${param.originalIndex}, ${inputIndex})">×</button>
                                                    </div>
                                                `).join('')}
                                            </div>
        ...
        function updateFormulaB() {
            ...
            // Create formula string (e.g., 2² × 3¹ × 4²)
            let formulaParts = [];
...
if (strength < 1) {
    ...
    document.getElementById('testCasesCount').innerHTML = `
        <div class="error-message gateway-message">
            ...
            <p style="font-family: monospace; text-align: center;">t ≥ 1</p>
        </div>
    `;
    return;
}
...
if (strength > paramValue) {
    ...
    return;
        ...
        function downloadTextB() {
            ...
            let cleaned = decodeRawResultToNames(lastRawResult);
            let count = cleaned.split("\n").length;
        ...
        Values: [${lastValues.join(", ")}]`;
            ...
            let footer = `Completed with ${count} test cases.`;
